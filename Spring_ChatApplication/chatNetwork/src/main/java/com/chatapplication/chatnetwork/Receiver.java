...
package com.chatapplication.chatnetwork;
...
public class Receiver extends Thread{
    ...
    public void connection() throws IOException, SQLException, ClassNotFoundException{
        ...
        while(true){
            socketReceiver = socketServer.accept();//accept socket tu noi gui den
            ObjectInputStream objectMessage = new ObjectInputStream(socketReceiver.getInputStream());//get object nhan duoc
